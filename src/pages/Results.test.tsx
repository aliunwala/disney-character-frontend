...
test("Render out <Results> page with mocked outlet data. Check if character cards were rendered", async () => {
  ...
  expect(screen.getByText(/Candace Adams/i)).toBeInTheDocument();
